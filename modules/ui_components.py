...
class VentanaVenta:
    ...
    def crear_widgets(self):
        ...
        frame_info = ttk.LabelFrame(self.ventana, text="📋 Datos del Campesino", padding="15")
...
"""
        ...
        # Frame de opciones
        frame_opciones = ttk.LabelFrame(self.ventana, text="¿Qué desea hacer?", padding="15")
        ...
        # Frame de costo
        frame_costo = ttk.LabelFrame(self.ventana, text="💰 Monto a Cobrar", padding="15")
...
class VentanaDetalleDia:
    ...
    def crear_widgets(self):
        ...
        # Frame superior
        frame_superior = ttk.Frame(self.ventana, padding="10")
        frame_superior.pack(fill=tk.X)
        ...
        # Frame de tabla
        frame_tabla = ttk.Frame(self.ventana, padding="10")
        ...
        frame_acciones = ttk.Frame(self.ventana, padding="10")
        ...
        # Frame de totales
        frame_totales = ttk.LabelFrame(self.ventana, text="Totales del Día", padding="10")
...
class VentanaHistorial:
    ...
    def crear_widgets(self):
        ...
        frame_info = ttk.LabelFrame(self.ventana, text="Información del Campesino", padding="10")
        frame_info.pack(fill=tk.X, padx=10, pady=10)
...
"""
        ...
        frame_siembras = ttk.LabelFrame(self.ventana, text="Historial de Siembras", padding="10")
        ...
        # Frame de recibos
        frame_recibos = ttk.LabelFrame(self.ventana, text="Recibos Emitidos", padding="10")
